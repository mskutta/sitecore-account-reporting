...
namespace Skutta.AccountReporting.Models.PageViewsByBusinessName
{
    public class ExperienceAnalyticsListControlViewModel : Sitecore.ExperienceAnalytics.Client.Mvc.Presentation.ExperienceAnalyticsListControlViewModel
    {
        public override void Initialize(Rendering rendering)
        {
            ...
            SetPrivatePropertyValue(typeof(DvcRenderingModel), this, "DataUrl", "/sitecore/api/ao/aggregates/pageviewsbybusinessname/{KEYS}");
        }
